...
/// <summary>Queryable index record for a persisted Giacom billing PDF ingestion run.</summary>
public sealed record GiacomPdfIngestionRun
{
    /// <summary>Unique identifier for this upload run.</summary>
    public required Guid IngestionId { get; init; }

    /// <summary>Always <see cref="ImportSourceKind.GiacomBillingPdf"/>.</summary>
    public ImportSourceKind SourceKind { get; init; } = ImportSourceKind.GiacomBillingPdf;

    /// <summary>Original upload filename when provided.</summary>
    public string? OriginalFileName { get; init; }

    /// <summary>SHA-256 hex fingerprint of the PDF bytes.</summary>
    ...
    public GiacomPdfIngestionSummary? Summary { get; init; }

    /// <summary>Blob path to the uploaded source PDF.</summary>
