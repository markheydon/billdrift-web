...
Store constructor: `AzureCatalogueReconciliationStore(BlobServiceClient client, IOptions<CatalogueReconciliationStorageOptions> options)` — **no manual connection strings**.
